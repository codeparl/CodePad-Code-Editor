...
public class LineNumberView extends JComponent
{
  ...
  public LineNumberView(JTextComponent text, JLabel  label)
  {
    if (text == null)
    {
...
//    Double scale = (Double) text.getDocument().getProperty("ZOOM_FACTOR");
//     int zoomFactor = 0;
//    if(scale != null)
//      zoomFactor  =  (int) (scale * 100);
    ...
    componentWidth = 2 * MARGIN + maxNumberWidth+textTopInset;
  ...
  public void paintComponent(Graphics g)
  {
    ...
    Rectangle clip = g.getClipBounds();
     ...
     int zoomFactor = 0;
    if(scale != null)
      zoomFactor  =  (int) (scale * 100/2);
    
    setPreferredSize(new Dimension(getWidth()+zoomFactor, getHeight()));
    
   // g.setFont(new Font(getFont().getFamily(), getFont().getStyle(),18));
